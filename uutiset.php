...
echo "<p>Saatuaan murskavoiton vuoden 2020 presidentinvaaleissa Presidentti Donald Trump ei ainoastaan murskannut 
äänestysprosentin, mutta myös koko demokraatti puolueen.</p>";
echo "<p>Hävittyään 2020 vaalit, demokraatit näyttivät todellisen nahkansa ja menettivät 95% äänestäjistään.</p>";
?>